...
def livestation():
    ...
    bt.pack(fill=X)
    def dis2():
        url = "http://indianrailapi.com/api/v2/LiveStation/apikey/{}/StationCode/{}/hours/{}/".format(apikey,e1.get(),e2.get())
        print(url)
        response = requests.get(url)
        response = response.json()
        print(response)
...
def livetrain():
    ...
    def dis2():
        url = "http://indianrailapi.com/api/v2/livetrainstatus/apikey/{}/trainnumber/{}/date/{}/".format(apikey, e1.get(),e2.get())
        print(url)
        response = requests.get(url)
        response = response.json()
        print(response)
...
def vacant():
    ...
    result.pack(fill=X)
    def dis2():
      url = "https://indianrailapi.com/api/v2/SeatAvailability/apikey/{}/TrainNumber/{}/From/{}/To/{}/Date/{}/Quota/GN/Class/{}".format(apikey, e1.get(),e2.get(),e3.get(),e4.get(),e5.get())
      print(url)
      response = requests.get(url)
      response = response.json()
      print(response)
